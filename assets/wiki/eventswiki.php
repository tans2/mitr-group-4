...
<button id="edit" class="btn btn-primary" onclick="editEvents()" type="button">Edit</button>
<button id="save" class="btn btn-primary" onclick="saveEvents()" type="button">Save</button><br>
