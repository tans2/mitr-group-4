...
$wiki = new wiki( "attendance", $mysqli );
?>
...
<button id="edit" class="btn btn-primary" onclick="editAttendance()" type="button">Edit</button>
<button id="save" class="btn btn-primary" onclick="saveAttendance()" type="button">Save</button><br>
<div class="attendancewiki"><?php echo $wiki->getBody() ?></div>
