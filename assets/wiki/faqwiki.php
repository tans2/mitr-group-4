...
<button id="edit" class="btn btn-primary" onclick="editFAQ()" type="button">Edit</button>
<button id="save" class="btn btn-primary" onclick="saveFAQ()" type="button">Save</button><br>
