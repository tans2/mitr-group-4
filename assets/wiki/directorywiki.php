...
<button id="edit" class="btn btn-primary" onclick="editDirectory()" type="button">Edit</button>
<button id="save" class="btn btn-primary" onclick="saveDirectory()" type="button">Save</button><br>
