...
<button id="edit" class="btn btn-primary" onclick="editHome()" type="button">Edit</button>
<button id="save" class="btn btn-primary" onclick="saveHome()" type="button">Save</button><br>
