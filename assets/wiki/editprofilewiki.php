...
<button id="edit" class="btn btn-primary" onclick="editEditProfile()" type="button">Edit</button>
<button id="save" class="btn btn-primary" onclick="saveEditProfile()" type="button">Save</button><br>
