...
<button id="edit" class="btn btn-primary" onclick="editAdmin()" type="button">Edit</button>
<button id="save" class="btn btn-primary" onclick="saveAdmin()" type="button">Save</button><br>
