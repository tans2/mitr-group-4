...
<button id="edit" class="btn btn-primary" onclick="editProfile()" type="button">Edit</button>
<button id="save" class="btn btn-primary" onclick="saveProfile()" type="button">Save</button><br>
