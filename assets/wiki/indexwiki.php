...
<button id="edit" class="btn btn-primary" onclick="editIndex()" type="button">Edit</button>
<button id="save" class="btn btn-primary" onclick="saveIndex()" type="button">Save</button><br>
